 ...
 *  bound by queue id only (the sound key), exactly as before. The sender moves
 *  the record under its queue id when the receipt names one, or drops it when
 *  the send did not queue. */
