...
function createIpcRegistrar({
  ...
  function registerShell() {
    ...
    ipcMain.handle("dashboard:open-file", async (event, filePath) => {
      ...
      // Three families are therefore excluded, all reachable only through this
      ...
      //     opens them at a `file://` origin and EXECUTES embedded JavaScript; and
